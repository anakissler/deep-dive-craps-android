  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ((Button) findViewById(R.id.playButton)).setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        game.play();
        ArrayAdapter<Game.Roll> adapter = new ArrayAdapter<Roll>
            (MainActivity.this, R.layout.rolls_list_item, game.getRolls());
        ((ListView) findViewById(R.id.rollsView)).setAdapter(adapter);
        ((TextView) findViewById(R.id.tallyView)).setText
            (String.format(getString(R.string.tally_message),
